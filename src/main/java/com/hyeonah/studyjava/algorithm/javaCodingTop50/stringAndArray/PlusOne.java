...
public class PlusOne {
    ...
    public static void main(String[] args) {
        int[] result = new PlusOne().solution(new int[]{1,2,3}); // [1,2,4]
        int[] result_1 = new PlusOne().solution(new int[]{1,0,0,2}); // [1,0,0,3]
        int[] result_2 = new PlusOne().solution(new int[]{9,9,9}); // [1,0,0,0]
        int[] result_3 = new PlusOne().solution(new int[]{0,0,1}); // [0,0,2]
