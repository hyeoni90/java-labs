...
public class MeetingRooms {
    ...
    public static void main(final String[] args) {
        ...
        final Interval interval1 = new Interval(15, 20);
        final Interval interval2 = new Interval(5, 10);
        final Interval interval3 = new Interval(0, 30);

        final Interval[] intervals = {interval1, interval2, interval3};

        // TODO: 2020/10/11 output: true (T/F)
        System.out.println(meetingRooms.solve(intervals));
    }

    public boolean solve(final Interval[] intervals) {
...
//    };
    ...
    public void print(final Interval[] intervals) {
